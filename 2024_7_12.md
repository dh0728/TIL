...
<p align="center">
   <img src="./readme_images/github_image.png" width="20%" height="20%"title="px(픽셀) 크기 설정"alt="logo"></img>
  <img src="/readme_images/gitlab.png" width="20%" height="20%"title="px(픽셀) 크기 설정"alt="logo"></img>
  <img src="/readme_images/bitbucket_logo.png" width="20%" height="20%"title="px(픽셀) 크기 설정"alt="logo"></img>
</p>
